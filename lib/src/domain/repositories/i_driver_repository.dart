...
abstract class IDriverRepository {
  Future<Either<DriverFailure, Unit>> update(Driver driver);
  ...
  ///
  /// Why not return Driver? This is because parsing big json to data object is expensive
  ...
  ///! For testing purpose
  Future<Unit> createMockDriver(Driver driver);
